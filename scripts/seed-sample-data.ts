...
import type { MovementLevel, FulfillmentStatus, SmokingStatus } from '@prisma/client'
...
// Seit N-09 ist nutrition ein FulfillmentStatus (erfüllt = Kaloriendefizit erreicht).
const NUTRITION_PATTERN: FulfillmentStatus[] = [
  'FULFILLED','FULFILLED','FULFILLED','NOT_FULFILLED','FULFILLED',
  'FULFILLED','FULFILLED','FULFILLED','FULFILLED','FULFILLED',
  'NOT_FULFILLED','FULFILLED','FULFILLED','FULFILLED','FULFILLED',
  'FULFILLED','FULFILLED','FULFILLED','FULFILLED','NOT_FULFILLED',
  'FULFILLED','FULFILLED','FULFILLED','FULFILLED','FULFILLED',
  'FULFILLED','NOT_FULFILLED','FULFILLED','FULFILLED','FULFILLED',
  'FULFILLED','FULFILLED','FULFILLED','FULFILLED','NOT_FULFILLED',
  'FULFILLED','FULFILLED','FULFILLED','FULFILLED','FULFILLED',
  'FULFILLED','FULFILLED','FULFILLED','NOT_FULFILLED','FULFILLED',
]
