...
export const WITHINGS_MEASURE_TYPES: Record<number, MeasureTypeMeta> = {
  ...
  173: { label: 'Fettfreie Masse (segmental)', unit: 'kg',   category: 'Körper' },
  174: { label: 'Fettmasse (segmental)',      unit: 'kg',    category: 'Körper' },
  175: { label: 'Muskelmasse (segmental)',    unit: 'kg',    category: 'Körper' },
  226: { label: 'Grundumsatz (BMR)',          unit: 'kcal',  category: 'Körper' },
  227: { label: 'Stoffwechselalter',          unit: 'Jahre', category: 'Körper' },
  ...
  158: { label: 'Nervengesundheit linker Fuss', unit: '',   category: 'Nerven' },
  159: { label: 'Nervengesundheit rechter Fuss', unit: '',  category: 'Nerven' },
  167: { label: 'Nervengesundheit (2 Füsse)', unit: '',     category: 'Nerven' },
