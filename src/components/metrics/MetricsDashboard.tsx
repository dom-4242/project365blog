...
function EmptyState() {
  return (
    <div className="rounded-2xl border border-sand-200 bg-sand-50 px-6 py-10 text-center">
...
export async function MetricsDashboard() {
  ...
  return (
    <section className="mb-14">
      <h2 className="font-display text-xl font-bold text-[#1a1714] mb-5">Metriken</h2>
