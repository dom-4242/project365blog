...
function ResultRow({ r }: { r: FitbitSyncResult }) {
  return (
    <tr className="border-b border-sand-100 last:border-0 text-xs">
      <td className="px-4 py-2.5 font-mono text-sand-500">{r.date}</td>
      <td className="px-4 py-2.5 text-[#2d2926]">{r.weight != null ? `${r.weight} kg` : '—'}</td>
      <td className="px-4 py-2.5 text-[#2d2926]">{r.bodyFat != null ? `${r.bodyFat}%` : '—'}</td>
      <td className="px-4 py-2.5 text-[#2d2926]">
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl border border-sand-200 p-5">
        <h3 className="font-display text-sm font-semibold text-[#1a1714] mb-4">
      ...
      {/* Date range backfill */}
      <div className="bg-white rounded-2xl border border-sand-200 p-5">
        <h3 className="font-display text-sm font-semibold text-[#1a1714] mb-1">
