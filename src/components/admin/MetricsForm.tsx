    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="flex items-center gap-3">
        <button
          type="button"
          onClick={prevDay}
          className="p-1.5 rounded-lg border border-sand-200 text-sand-500 hover:text-[#1a1714] hover:border-sand-300 transition-colors"
      ...
      <div className="bg-white rounded-2xl border border-sand-200 p-5">
        <h3 className="font-display text-sm font-semibold text-[#1a1714] mb-4">Körperwerte</h3>
      ...
      {/* Aktivität */}
      <div className="bg-white rounded-2xl border border-sand-200 p-5">
        <h3 className="font-display text-sm font-semibold text-[#1a1714] mb-4">Aktivität</h3>
      ...
      {/* Vitalwerte */}
      <div className="bg-white rounded-2xl border border-sand-200 p-5">
        <h3 className="font-display text-sm font-semibold text-[#1a1714] mb-4">Vitalwerte</h3>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
      ...
      {success && (
        <div className="p-3 bg-movement-50 border border-movement-200 rounded-lg text-sm text-movement-700">
