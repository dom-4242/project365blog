  ...
  return (
    <span
      className={clsx(
        ...
        fulfilled ? colorClass : 'bg-sand-100 text-sand-500'
      )}
    >
      <span
        className={clsx(
...
export function HabitsPicker({
  ...
  return (
    <div className="bg-white rounded-2xl border border-sand-200 overflow-hidden">
      {/* Header */}
      <div className="flex items-center justify-between px-5 pt-4 pb-3 border-b border-sand-100">
        <h3 className="font-display text-sm font-semibold text-[#1a1714]">Die drei Säulen</h3>
        <span
          className={clsx(
      ...
      {/* Live-Vorschau */}
      <div className="flex items-center gap-3 px-5 py-3 bg-sand-50 border-t border-sand-100">
