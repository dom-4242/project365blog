  ...
  return (
    <button
      ...
      className={cn(
        ...
        active
          ? 'bg-sand-200 text-[#1a1714] ring-1 ring-sand-300 scale-105'
          : 'bg-white border border-sand-200 text-sand-500 hover:bg-sand-100 hover:text-sand-700 hover:border-sand-300',
